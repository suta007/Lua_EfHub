...
local BuyList ={
    ...
    ["ROOT/GearStock/Stocks"]={
        Enabled=true,
        BuyAll=false,
        Items={"Watering Can","Trowel","Recall Wrench","Basic Sprinkler","Advanced Sprinkler","Godly Sprinkler","Master Sprinkler","Grandmaster Sprinkler","Levelup Lollipop","Medium Toy","Medium Treat","Pet Lead","Harvest Tool","Magnifying Glass","Cleaning Spray","Favorite Tool","Harvest Tool","Cleansing Pet Shard"},
