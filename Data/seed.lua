...
local SeedList= {
	...
	["Elder Strawberry"] = {
		Seed = SeedData["Elder Strawberry"];
		StockChance = 405;
		StockAmount = {1, 1};
		Price = 70000000;
	...
	["Beast Buttercup"] = {
		Seed = SeedData["Beast Buttercup"];
		StockChance = 1500;
		StockAmount = {1, 1};
		Price = 500000000000;
		PurchaseID = 3519865801;
		GiftPurchaseID = 3519865904;
		DisplayInShop = true;
		LayoutOrder = 401;
		GrowthTime = 1;
		FallbackPrice = 1320;
	...
	["Bonanza Bloom"] = {
		Seed = SeedData["Bonanza Bloom"];
		StockChance = 700;
		StockAmount = {1, 1};
		Price = 1000000000000;
		PurchaseID = 3498980651;
		GiftPurchaseID = 3498981023;
		DisplayInShop = true;
		LayoutOrder = 431;
		GrowthTime = 1;
		FallbackPrice = 1299;
		RebirthRequirement = 3;
		EndTime = 1735927200;
		Description = "PLANT ABILITY: Every 5 min, reduces a nearby eggs hatch time by 30 secs for every Carnival Cosmetic you have on your garden.";
		IsLimited = true;
	};
	Broccoli = {
		Seed = SeedData.Broccoli;
		StockChance = 1;
		StockAmount = {1, 1};
		Price = 2;
...
for seedName, seedInfo in pairs(SeedList) do
    SeedData[seedName] = seedInfo
end
print("Seed data loaded with " .. tostring(#SeedList) .. " entries.")
